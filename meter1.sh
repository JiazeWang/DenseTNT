python src/run.py --argoverse --future_frame_num 30 \
  --do_train --data_dir train/data/ --output_dir meter1/test \
  --hidden_size 128 --train_batch_size 64 --sub_graph_batch_size 4096 --use_map \
  --core_num 16 --use_centerline --distributed_training 4 --reuse_temp_file --temp_file_dir meter1 \
  --other_params \
  ...
  --neighbour_dis 1 --do_eval --eval_batch_size 16 --model_recover_path meter1/model_save/model.50.bin
