...
class VectorNet(nn.Module):
    ...
    def forward(self, mapping: List[Dict], device):
        ...
        outputs_coord, coord_length = utils.merge_tensors_coor(outputs_coord_batch,hidden_size0=36, hidden_size1=2, device=device)
        outputs_class, class_length = utils.merge_tensors_class(outputs_class_batch,hidden_size0=36, device=device)
        outputs_traj, traj_length = utils.merge_tensors_traj(outputs_traj_batch, hidden_size0=36, hidden_size1=30, hidden_size2=2, device=device)
        outputs_centerness, centerness_length = utils.merge_tensors_class(outputs_centerness_batch,hidden_size0=36, device=device)
