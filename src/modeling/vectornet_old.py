...
from modeling.decoder_v2 import Decoder_predict, DecoderResCat
...
class VectorNet(nn.Module):
    ...
    def forward(self, mapping: List[Dict], device):
        ...
        print("element_states_batch.shape, lane_states_batch.shape", element_states_batch[0].shape, lane_states_batch[0].shape)
